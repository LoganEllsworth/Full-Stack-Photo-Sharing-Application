...
const getPhotosByTagName = "SELECT P.* FROM photos AS P LEFT JOIN tags AS T ON T.photoid = P.id LEFT JOIN albums AS A ON P.albumid = A.id LEFT JOIN users AS U ON A.userid = U.id WHERE T.name = $1 AND U.id = $2";
